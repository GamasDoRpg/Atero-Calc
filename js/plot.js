...
const PLOT_STORAGE_KEY = "atero-calc-plot-v1";
...
// O erro específico é exibido na própria função.
}
}
...
expressionList.addEventListener(
"compositionstart",
() => {
...
const oldXSpan =
state.viewport.xMax - state.viewport.xMin;
const oldYSpan =
